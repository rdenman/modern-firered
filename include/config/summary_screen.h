...
// IV/EV settings
// Modern FireRed (S09): party+box always-on cycle with raw numbers + IV/EV tileset.
// See docs-mf/decisions/0009-ux-summary-iv-ev-display.md. Phase 10 may later gate via
// P_FLAG_SUMMARY_SCREEN_IV_EV_INFO / Options+; leave that flag at 0 for now.
